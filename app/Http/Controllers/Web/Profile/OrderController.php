...
class OrderController extends Controller
{
    ...
    {
        $orders = Order::where('user_id', Auth::user()->id)->select('id', 'cart_id', 'portal', 'status', 'advance_price', 'total_deal_price','instalment_tenure','created_at')->orderBy('id','desc')->paginate(10);
        // dd($orders[0]->cart);
