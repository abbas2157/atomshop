(function ($) {
    ...
    $(".add-to-cart").click(function(e) {
        ...
        if (user_id && user_id.value) {
            var data = { product_id: product_id, memory_id: memory_id, color_id: color_id, price: price, min_advance_price: min_advance_price, tenure_months : tenure_months, user_type : user_type, user_id : user_id.value };
        } else {
            var data = { product_id: product_id, memory_id: memory_id, color_id: color_id, price: price, min_advance_price: min_advance_price, tenure_months : tenure_months, user_type : user_type, guest_id : guest_id };
        }
        $.ajax({
