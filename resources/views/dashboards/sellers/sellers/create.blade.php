...
<div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
    <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
            ...
            <form id="product-form-name" method="POST" action="{{ route('seller.sellers.store') }}" enctype="multipart/form-data">
                @csrf
                <div id="product-form">
                    <h3>Sellers Information</h3>
                    @include('dashboards/sellers/sellers/create-partials/personal-information')
                    <h3>Business Address</h3>
                    @include('dashboards/sellers/sellers/create-partials/business-address')
                    <h3>Business Details</h3>
                    @include('dashboards/sellers/sellers/create-partials/product-details')
        ...
        $(function() {
            ...
            $('#product-form').steps({
                ...
                onFinishing: function (event, currentIndex) {
                    ...
                    $.ajax({
                        url: "{{ route('seller.sellers.store') }}",
                        type: 'POST',
                        data: formData,
                        contentType: false,
                        processData: false,
