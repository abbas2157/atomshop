                    ...
                    <div class="col-lg mt-2">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn" title="Clear Search">
                                <a href="{{ route('admin.customers.index') }}" class="btn btn-warning" type="submit" style="padding: 8px 20px;"><i class="far fa-arrow-alt-circle-left"></i></a>
                            </span>
                            <span class="input-group-btn" title="Create New">
                                <a href="{{ route('admin.customers.create') }}" class="btn btn-info" type="submit" style="padding: 8px 20px;"><i class="typcn typcn-document-add"></i></a>
                            </span>
                        </div>
                    </div>
                </div>
