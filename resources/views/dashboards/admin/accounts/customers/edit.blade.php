                ...
                <form method="POST" action="{{ route('admin.customers.update', $user->uuid) }}" enctype="multipart/form-data">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-lg mt-2">
                            ...
                            <select class="form-control select2" id="select2" name="area_id" id="area_id"
                                id="select-area">
                                @if ($areas->isNotEmpty())
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-lg mt-2">
                            ...
                            <select class="form-control" name="verified" id="verified">
                                <option value="1"
                                    {{ old('verified', $user->customer->verified ?? '') == '1' ? 'selected' : '' }}>Yes
                                </option>
                                <option value="0"
                                    {{ old('verified', $user->customer->verified ?? '') == '0' ? 'selected' : '' }}>No
                                </option>
                            </select>
                        </div>
                    </div>
                    <div
                        class="yes-verified {{ is_null($user->customer) || $user->customer->verified == '0' ? 'd-none' : '' }}">
                        ...
                        <div class="row row-sm">
                            <div class="col-lg mt-2">
                                ...
                                @if (!empty($user->customerVerification->selfie_with_customer))
                                    <img src="{{ asset($user->customerVerification->selfie_with_customer) }}"
                                        width="100" height="100">
                                @endif
                                @if ($errors->has('selfie_with_customer'))
                                    <span
                                        class="text-danger text-left">{{ $errors->first('selfie_with_customer') }}</span>
                                @endif
                            </div>
                            <div class="col-lg mt-2">
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="col-lg mt-2">
                                ...
                                @if ($errors->has('customer_physical_meet'))
                                    <span
                                        class="text-danger text-left">{{ $errors->first('customer_physical_meet') }}</span>
                                @endif
                            </div>
                        </div>
                        <div class="row row-sm">
                    ...
                    <div
                        class="no-verified {{ !is_null($user->customer) && $user->customer->verified == '1' ? 'd-none' : '' }}">
                        <div class="row row-sm">
                            <div class="col-lg mt-2">
...
@section('js')
    <script>
        $(document).on('change', "#verified", function(sevent) {
