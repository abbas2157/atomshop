...
<div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
    <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
            ...
            <p class="mg-b-20">All sliders list here to view, edit & delete</p>
            <form action="">
                    ...
                    <div class="col-lg mt-2">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn" title="Clear Search">
                                <a href="{{ route('admin.sliders.index') }}" class="btn btn-warning" style="padding: 8px 20px; color:white;"><i class="far fa-arrow-alt-circle-left"></i></a>
                            </span>
                            <span class="input-group-btn" title="Create New">
                                <a href="{{ route('admin.sliders.create') }}" class="btn btn-info" style="padding: 8px 20px; color:white;"><i class="typcn typcn-document-add"></i></a>
                            </span>
                        </div>
                    </div>
                </div>
                        ...
                        @if($sliders->isNotEmpty())
                            @foreach($sliders as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.sliders.edit',$item->id) }}">View</a> |
                                        <a href="{{ route('admin.sliders.edit',$item->id) }}">Edit</a> | 
                                        <a href="javascript:;" id="delete-btn">Delete</a>
                                        <form id="delete-form" action="{{ route('admin.sliders.destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
...
<script>
    $(document).on('click', '#delete-btn', function () {
        if (confirm('Are you sure you want to delete this Sliders?')) {
            $('#delete-form').submit();
        }
    });
</script>
