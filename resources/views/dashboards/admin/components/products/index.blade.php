                    ...
                    <div class="col-lg">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn" title="Clear Search">
                                <a href="{{ route('admin.products.index') }}" class="btn btn-warning" type="submit" style="padding: 8px 20px;"><i class="far fa-arrow-alt-circle-left"></i></a>
                            </span>
                            <span class="input-group-btn" title="Create New">
                                <a href="{{ route('admin.products.create') }}" class="btn btn-info" type="submit" style="padding: 8px 20px;"><i class="typcn typcn-document-add"></i></a>
                            </span>
                        </div>
                    </div>
                </div>
