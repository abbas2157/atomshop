<section>
    ...
    <div class="row">
        <div class="col-12 mb-3">
            ...
            <textarea id="short_description" class="form-control" required name="short" placeholder="Enter short description" rows="5">{{ old('short', $productdescription->short) }}</textarea>
             @if ($errors->has('short'))
