                    ...
                    <div class="col-lg mt-2">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn" title="Clear Search">
                                <a href="{{ route('admin.categories.index') }}" class="btn btn-warning" style="padding: 8px 20px; color:white;"><i class="far fa-arrow-alt-circle-left"></i></a>
                            </span>
                            <span class="input-group-btn" title="Create New">
                                <a href="{{ route('admin.categories.create') }}" class="btn btn-info" style="padding: 8px 20px; color:white;"><i class="typcn typcn-document-add"></i></a>
                            </span>
                        </div>
                    </div>
                </div>
