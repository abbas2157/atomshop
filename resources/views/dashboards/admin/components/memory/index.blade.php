    ...
    <div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
        <div class="container">
            ...
            <div class="az-content-body pd-lg-l-40 d-flex flex-column">
                ...
                <p class="mg-b-20">All memory list here to view, edit & delete</p>
                <form action="">
                        ...
                        <div class="col-lg mt-2">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn" title="Clear Search">
                                    <a href="{{ route('admin.memory.index') }}" class="btn btn-warning" type="submit" style="padding: 8px 20px; color:white;"><i class="far fa-arrow-alt-circle-left"></i></a>
                                </span>
                                <span class="input-group-btn" title="Create New">
                                    <a href="{{ route('admin.memory.create') }}" class="btn btn-info" type="submit" style="padding: 8px 20px; color:white;"><i class="typcn typcn-document-add"></i></a>
                                </span>
                            </div>
                        </div>
                    </div>
                            ...
                            @if($memory->isNotEmpty())
                                @foreach($memory as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.memory.edit',$item->id) }}">View</a> |
                                            <a href="{{ route('admin.memory.edit',$item->id) }}">Edit</a> | 
                                            <a href="javascript:;" id="delete-btn">Delete</a>
                                            <form id="delete-form" action="{{ route('admin.memory.destroy', $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
                ...
                <div class="mt-2">
                    {!! $memory->withQueryString()->links('pagination::bootstrap-5') !!} 
                </div>
            </div>
        </div>
    </div>
