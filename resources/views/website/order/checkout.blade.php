                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="text" name="name" placeholder="Enter full name" value="{{ Auth::user()->name ?? '' }}" @auth readonly @endauth required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Mobile No (موبائل نمبر)</label>
                            <input class="form-control" type="text" name="phone" placeholder="+92 300 1122333" value="{{ Auth::user()->phone ?? '' }}" @auth readonly @endauth required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>E-mail (ای میل ایڈریس)</label>
                            <input class="form-control" name="email" type="text" placeholder="example@email.com" value="{{ Auth::user()->email ?? '' }}" @auth readonly @endauth required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group">
