...
@section('title')
    <title>Payment History | {{ config('website.name') ?? '' }} - {{ config('website.tagline') ?? '' }}</title>
...
<div class="container-fluid">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-9 col-md-8">
            <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Payment History</span></h5>
                ...
                <div class="table-responsive mb-3">
                    <table class="table table-bordered mb-0">
                        ...
                        <tbody class="align-middle">
                            ...
                            @else
                                <tr>
                                    <td colspan="6" class="text-center align-middle"> No payment history found.</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
