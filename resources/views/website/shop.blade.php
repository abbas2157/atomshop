                ...
                <div class="bg-light p-4 mb-30">
                    <form id="filterForm" action="{{ route('products.filter') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="min-price" name="min_price" class="form-control" placeholder="0"
                                min="0" value="{{ request('min_price') }}">
                        </div>
                        <div class="form-group">
                            <label for="max-price">Max Price</label>
                            <input type="number" id="max-price" name="max_price" class="form-control" placeholder="500"
                                min="0" value="{{ request('max_price') }}">
                        </div>
