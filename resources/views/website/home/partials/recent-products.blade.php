...
@if(!empty($products))
    <div class="container-fluid pt-2 pb-2">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Top Rated Products</span></h2>
                    ...
                    <div class="product-item bg-light mb-2">
                        <div class="product-img position-relative overflow-hidden text-center py-3">
                            ...
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square add-to-favorites" href="" data-id="{{ $item->id }}"><i class="far fa-heart"></i></a>
                            </div>
                        </div>
                        <div class="py-2 px-4">
